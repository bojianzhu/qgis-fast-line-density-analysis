...
from .ldvAlgorithm import LDVAlgorithm
from qgis.PyQt.QtGui import QIcon

class LineDensityAnalysisProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(LDVAlgorithm())
    ...
    def name(self):
        ...
        """
        return self.tr('Fast line density analysis')
